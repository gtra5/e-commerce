...
function Slideproducts() {
  ...
  useEffect(() => {
    ...
    const fetchAutomotiveProducts = async () => {
      try {
        ...
        // Combine both automotive categories
        const automotiveProducts = [
          ...(motorcycleData.products || []),
          ...(vehicleData.products || []),
        ];
  ...
  return (
    <div className="relative w-full mx-auto py-4 sm:py-6 font-montserrat">
      <div className="bg-gradient-to-r from-gray-700 to-black rounded-t-none  flex flex-col items-start p-4 sm:p-6 md:flex-row md:items-center md:rounded-t-xs md:justify-between">
