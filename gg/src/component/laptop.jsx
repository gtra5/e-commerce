...
function Laptops() {
  ...
  useEffect(() => {
    ...
    const fetchlaptops = async () => {
      try {
        ...
        const LaptopProducts = [...(LaptopData.products || [])];
  ...
  return (
    <div className="relative w-full mx-auto py-4 sm:py-6 font-montserrat">
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-none shadow-lg flex flex-col items-start p-4 sm:p-6 md:flex-row md:items-center md:rounded-t-2xl md:justify-between">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="bg-white/20 p-1.5 sm:p-2 rounded-lg">
            <LaptopMinimal className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
          </div>
          <div>
