...
const searchSuggestions = {
  electronics: ["laptop", "smartphone", "headphones", "camera", "tablet", "speakers"],
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-2 md:py-4 flex flex-col md:flex-row items-center md:justify-between gap-3 md:gap-0">
            ...
            <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-b-lg shadow-lg z-50 max-h-96 overflow-y-auto">
              {recentSearches.length > 0 && (
                <div className="p-3 border-b border-gray-100">
                  <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Recent Searches</h4>
              ...
              {!searchQuery.trim() && (
                <div className="p-3">
                  <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Popular Searches</h4>
        ...
        <div className="hidden md:flex items-center space-x-6 text-gray-700 text-base">
            ...
            {isAccountOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white rounded shadow-lg py-2 z-50">
                {user ? (
                  ...
                  <>
                    <a href="/signIn" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                      Sign In
                    </a>
          ...
          <div className="relative">
            ...
            {isHelpOpen && (
              <div className="absolute right-0 mt-2 w-40 bg-white rounded shadow-lg py-2 z-50">
                <a href="/customer-care" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  Customer Care
                </a>
                <a href="/faqs" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  FAQs
                </a>
              ...
              {!loadingCategories && categories.length > 0 && (
                <div className="space-y-1 max-h-60 overflow-y-auto">
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-gray-700 rounded-xl transition-all duration-200 ${
                  ...
                  {categories.map((category) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {selectedCategory === category.slug && <CheckCircle className="w-4 h-4" />}
                      </div>
                    </button>
                  ))}
                </div>
